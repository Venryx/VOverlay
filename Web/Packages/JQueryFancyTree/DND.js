...
function _registerDnd() {
	...
	$.ui.plugin.add("draggable", "connectToFancytree", {
		...
		drag: function(event, ui) {
			...
			{
				//if ($(event.target).is(".ui-droppable"))
				var droppable = $(event.target).closest(".ui-droppable");
				if (droppable.length)
				{
					var targetNode_fake = sourceNode;
					ui.helper.data("ftTargetNode", targetNode_fake);

					//var accept = $(event.target).droppable("option").accept(null, null, {node: sourceNode});
					var accept = droppable.droppable("option").accept(null, null, {node: sourceNode});
					sourceNode.tree.ext.dnd._setDndStatus(null, targetNode_fake, ui.helper, "over", accept);
				}
